...
public class PantallaEntregado extends JFrame {
	 ...
	 */
			...
			public void run() {
				try {
					PantallaEntregado frame = new PantallaEntregado();
	...
	public PantallaEntregado() {
		...
		JLabel lblNewLabel = new JLabel("Entregados");
		...
		for (Operacion operacion : operaciones.MostrarOp2()) {
